...
// /* ═══════════════════════════════════════════════
//  *  MAP CHUẨN HÓA — scale riêng chiều + và -
//  *  Đảm bảo tiến/lùi đều đạt PWM_MAX khi đẩy hết
//  * ═══════════════════════════════════════════════ */
...
// /* ═══════════════════════════════════════════════
//  *  TÍNH SPEED VÀ CLAMP — dùng chung 2 nơi
//  * ═══════════════════════════════════════════════ */
...
//     /* Rẽ mềm: bánh chậm không quay ngược — clamp về PWM_TURN_MIN
//      * thay vì về 0 để xe vẫn di chuyển chậm                       */
//     if (base >= 0 && turn != 0) {
//         if (left  < 0) left  = PWM_TURN_MIN;   // tiến: bánh trái tối thiểu
//         if (right < 0) right = PWM_TURN_MIN;   // tiến: bánh phải tối thiểu
//     } else if (base < 0 && turn != 0) {
//         if (left  > 0) left  = -PWM_TURN_MIN;  // lùi: bánh trái tối thiểu
//         if (right > 0) right = -PWM_TURN_MIN;  // lùi: bánh phải tối thiểu
//     }
...
//     // Max deflect mỗi chiều tính từ tâm
//     int max_dx_pos = 4095 - center_x;  // tiến
//     int max_dx_neg = center_x;          // lùi
//     int max_dy_pos = 4095 - center_y;  // phải
//     int max_dy_neg = center_y;          // trái
